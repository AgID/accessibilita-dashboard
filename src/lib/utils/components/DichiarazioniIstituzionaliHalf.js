export default {
  it: {
    "dicIstHalf.cardOneTitle":
      "Siti web istituzionali censiti su Indice PA che hanno pubblicato la dichiarazione nel {{anno}}",
    "dicIstHalf.cardTwoTitle":
      "Totale di siti web istituzionali censiti su Indice PA nel {{anno}}",
    "dicIstHalf.description":
      "Nel {{anno}} il {{percentuale}}% dei siti web istituzionali censiti su Indice PA ha pubblicato la propria dichiarazione di accessibilità.",
  },
  en: {
    "dicIstHalf.cardOneTitle":
