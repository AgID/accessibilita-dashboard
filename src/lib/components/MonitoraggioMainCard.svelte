...
<div class="d-flex flex-wrap">
  <div class="col-12 col-lg-6 col-xl-7 flex-wrap">
    <div class="mt-3 mb-4">
      <div class="d-inline-flex">
        <span aria-hidden="true"
          ...
          /></span
        >
        <h2 class="lead mx-3">{$t("moniMainCard.title")}</h2>
      </div>
    ...
    <h3 class="h3">
      {$t("moniMainCard.subtitle")}
    </h3>
    <p class="py-3 pe-xl-5 me-xl-5">
      {$t("moniMainCard.description")}
    <br/><br/>
    {$t("moniMainCard.descriptionContinued")}
  </p>
  </div>
...
{#if innerWidth < 992}
  <div class="col-12 col-lg-7 col-xl-7 flex-wrap">
    <p class="py-3">
      {$t("moniMainCard.description")}
    </p>
  </div>
