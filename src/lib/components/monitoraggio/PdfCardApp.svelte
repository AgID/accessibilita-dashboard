<script>
  ...
  onMount(async () => {
    ...
    numSiti = data.find((d) => d.indicatore == "num siti con pdf valutati").valore;
    numPA = data.find((d) => d.indicatore == "num enti con pdf valutati").valore;
...
<div class="d-flex flex-wrap mb-3">
  <div class="col-12 col-lg-6 col-xl-7 flex-wrap">
    ...
    <h3 class="h3">
      {$t("moniPDFCard.subtitleApp")}
    </h3>
    <p class="py-3 pe-xl-5 me-xl-5">
      {@html $t("moniPDFCard.descriptionApp", {break: "<br/>"})}
    </p>
  </div>
