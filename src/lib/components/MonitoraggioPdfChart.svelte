...
<div class="card-box mt-2 my-lg-3 hide-mobile pt-3 px-3">
  ...
  <div>
    <p class="mb-0 pb-3 px-2 px-xl-3">
      {@html $t("moniPDFChart.chartDescription", {break: "<br/>", total: numPDF})}
      <br><a href="/errori#pdf">{$t("errPdfTable.title")}</a>
    </p>
  ...
  <div class="show-mobile">
    ...
    >
      <div slot="didascaliaSlot" class="didascalia">
        {@html $t("moniPDFChart.tableDescription",  {break: "<br/>", total: numPDF})}
        <br><a href="/errori#pdf">{$t("errPdfTable.title")}</a>
      </div>
    </DataTable>
  </div>
